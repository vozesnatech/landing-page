      ...
      <div className="container mx-auto px-6 md:px-12">
        <div className="grid md:grid-cols-4 gap-12">
          ...
          <div>
            <div className="flex items-center gap-2 mb-6">
              <span className="text-2xl font-bold">
                <img src="./png 1-01.png" alt="logo no rodapé"/>
              </span>
            </div>
            <div className="flex items-center gap-4">
              <a href="#" className="w-10 h-10 rounded-full bg-primary flex items-center justify-center hover:bg-magenta-dark transition-colors">
                <svg className="w-5 h-5 fill-primary-foreground" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <p className="text-muted-foreground mb-2">21 XXXXX-XXXX</p>
            <p className="text-muted-foreground">xxxxxxx@email.com</p>
            
            <h4 className="font-bold text-foreground mt-6 mb-4">Menu</h4>
          ...
          <div className="md:col-span-2">
            <h4 className="font-bold text-foreground mb-4">Vamos conversar</h4>
            <form className="space-y-4">
              ...
              <button
                type="submit"
                className="px-8 py-3 rounded-full bg-primary text-primary-foreground font-semibold hover:bg-magenta-dark transition-colors"
              >
                Enviar
              </button>
            </form>
